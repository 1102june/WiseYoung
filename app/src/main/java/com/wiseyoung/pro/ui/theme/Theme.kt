...
private val DarkColorScheme = darkColorScheme(
    ...
    background = Color(0xFF000000),  // 순수 검은색 배경
    onBackground = Color(0xFFFFFFFF),  // 흰색 텍스트
    
    surface = Color(0xFFE5E5E5),  // 밝은 회색/흰색 계열 서페이스 (카드/다이얼로그용)
    onSurface = Color(0xFF1A1A1A),  // 검은색 텍스트 (회색 배경 위)
    surfaceVariant = Color(0xFFF5F5F5),  // 더 밝은 회색/흰색 (서페이스 변형)
    onSurfaceVariant = Color(0xFF1A1A1A),  // 검은색 텍스트
    
    outline = Color(0xFF1A1A1A),  // 어두운 테두리
    outlineVariant = Color(0xFF0F0F0F),  // 더 어두운 테두리 변형

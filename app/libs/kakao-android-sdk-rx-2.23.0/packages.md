...
[메시지 템플릿](https://developers.kakao.com/docs/latest/ko/message-template/common) 패키지<br>Package for [message templates](https://developers.kakao.com/docs/latest/en/message-template/common)

# Package com.kakao.sdk.template.model
[메시지 템플릿](https://developers.kakao.com/docs/latest/ko/message-template/common) 모델 패키지<br>Package for [message templates](https://developers.kakao.com/docs/latest/en/message/message-template) model

# Package com.kakao.sdk.share
[카카오톡 공유](https://developers.kakao.com/docs/latest/ko/kakaotalk-message/common) API 패키지<br>Package for the [Kakao Talk Sharing](https://developers.kakao.com/docs/latest/en/kakaotalk-message/common) APIs

# Package com.kakao.sdk.share.model
[카카오톡 공유](https://developers.kakao.com/docs/latest/ko/kakaotalk-message/common) API 모델 패키지<br>Package for the [Kakao Talk Sharing](https://developers.kakao.com/docs/latest/en/kakaotalk-message/common) APIs model
